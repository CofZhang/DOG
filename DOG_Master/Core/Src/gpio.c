...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, LED6_Pin|LED7_Pin|LED8_Pin|LED4_Pin
  ...
  /*Configure GPIO pin : BIAO_Pin */
  GPIO_InitStruct.Pin = BIAO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BIAO_GPIO_Port, &GPIO_InitStruct);
